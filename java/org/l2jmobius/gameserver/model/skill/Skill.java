...
public class Skill implements IIdentifiable
{
	...
	private final SkillHolder _alternateEnemySkill;
	private final SkillHolder _alternateAllySkill;
	...
	public Skill(StatSet set)
	{
		...
		final int alternateEnemySkillId = set.getInt("alternateEnemySkillId", 0);
		_alternateEnemySkill = alternateEnemySkillId > 0 ? new SkillHolder(alternateEnemySkillId, _level, _subLevel) : null;
		final int alternateAllySkillId = set.getInt("alternateAllySkillId", 0);
		_alternateAllySkill = alternateAllySkillId > 0 ? new SkillHolder(alternateAllySkillId, _level, _subLevel) : null;
	}
	...
	public Skill getAlternateEnemySkill()
	{
		return _alternateEnemySkill == null ? null : _alternateEnemySkill.getSkill();
	}
	
	public Skill getAlternateAllySkill()
	{
		return _alternateAllySkill == null ? null : _alternateAllySkill.getSkill();
	}
	...
	public void activateSkill(Creature caster, Item item, WorldObject... targets)
	{
		...
		{
			caster.getActingPlayer().setLastSkillUsed(this);
		}
