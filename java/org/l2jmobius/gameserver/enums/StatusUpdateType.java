...
public enum StatusUpdateType
{
	...
	CUR_LP(0x2F, creature -> creature.isPlayer() ? creature.getActingPlayer().getLightPoints() : 0),
	MAX_LP(0x30, creature -> creature.isPlayer() ? creature.getActingPlayer().getMaxLightPoints() : 0);
